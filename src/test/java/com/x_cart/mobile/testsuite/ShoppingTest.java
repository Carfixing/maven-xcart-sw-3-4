...
//        Assert.assertEquals(expectedMessage4, actualMessage4, "Can not match with Valid Text");*/
       ...
       Assert.assertEquals("Secure Checkout", secureCheckOutPage.verifySecureCheckOutPageOnSecurePage());
        ...
        secureCheckOutPage.enterFirstNameOnSecureCheckOutPage("Akashay");
        secureCheckOutPage.enterLastNameOnSecureCheckOutPage("Patel");
        secureCheckOutPage.enterAddressOnSecureCheckOutPage("alendealRoad");
        secureCheckOutPage.enterCityOnSecureCheckOutPage("London");
        secureCheckOutPage.enterCountryCodeOnSecureCheckOutPage("United Kingdom");
        secureCheckOutPage.enterStateOnSecureCheckOutPage("Harrow");
        secureCheckOutPage.enterZipCodeOnSecureCheckOutPage("W1 2DN");
        secureCheckOutPage.enteremailOnSecureCheckOutPage("prime123@gmail.com");
